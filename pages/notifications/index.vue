  ...
  <div class="flex mx-12 flex-row justify-start">
    <div class="w-1/2">
      ...
      <div
        ...
        class="bg-gray-dark p-6 text-center text-white font-bold"
      >
        <p>Zero Contacts</p>
      </div>
      <teleport to="body">
    ...
    <div class="pt-0 ml-16 w-1/3">
      ...
      <form @submit.prevent="handelAddFaq" action="#" class="">
        ...
        <button
          type="submit"
          class="py-3 my-3 px-5 bg-opacity-50 hover:bg-opacity-90 text-center rounded-lg bg-yellow-bright sm:w-full text-primary4 font-bold"
        >
          ADD
        </button>
      </form>
