...
<template>
  <div class="register">
    ...
    <div
      ...
      class="auth bg-primary3 bg-no-repeat bg-cover bg-center relative py-12"
    >
      ...
      <div class="min-h-screen sm:flex sm:flex-row mx-0 justify-center">
        <div class="flex justify-center self-center z-10">
          <div class="p-8 bg-white mx-auto w-96 rounded-3xl w-100">
            <div class="mb-4">
              <h3 class="font-semibold text-2xl text-movie-gray-900">
                Reset Password
              </h3>
              ...
              <div class="space-y-3">
                ...
                <div class="space-y-2 flex flex-col">
                  ...
                  <Field
                    ...
                    type="password"
                    class="w-full text-base px-4 py-2 border border-gray rounded-lg focus:border focus:border-primary-500 focus:border-solid"
            ...
            <div class="mt-4">
              <p class="hover:text-orange-500 text-orange-400">
                <NuxtLink class="text-primary9" to="/auth/login"
                  >Login</NuxtLink
                >
              </p>
            </div>
