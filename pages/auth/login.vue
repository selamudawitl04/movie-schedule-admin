...
<template>
  <div class="login">
    ...
    <div
      ...
      class="auth bg-primary3 bg-no-repeat bg-cover bg-center relative pt-12"
      style=""
    >
      <div
        ...
        >
          <div class="self-start hidden lg:flex flex-col text-white">
            ...
            <h1 class="mb-3 font-bold text-5xl">
              Hi 👋 Welcome <span class="text-primary-500">Admin</span>
            </h1>
            <p class="pr-3"></p>
          </div>
        </div>
              ...
              >
                <div class="space-y-2 flex flex-col">
                  ...
                  <Field
                    ...
                    type="email"
                    class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:border-primary-500"
                ...
                <div class="space-y-2 flex flex-col">
                  ...
                  <Field
                    ...
                    type="password"
                    class="w-full text-base px-4 py-2 border border-gray-300 rounded-lg focus:border focus:border-primary-500 focus:border-solid"
                ...
                <div class="flex justify-center">
                  <button
                    ...
                    class="w-44 flex justify-center bg-primary-500 opacity-80 hover:opacity-100 text-white p-3 rounded-full tracking-wide font-semibold shadow-lg cursor-pointer transition ease-in duration-400"
                  >
                    Sign in
                    <span
                      v-if="loading"
