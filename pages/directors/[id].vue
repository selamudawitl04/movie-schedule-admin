...
// fetch director
const { onResult, loading:directorLoading, onError:directorError, refetch } = query(getDirector,  {id})
onResult((result) => {
...
const {mutate, onDone, onError, loading} = mutation(editDirector);
...
<template>
  <div>
    ...
    <ActordirectorAdd :item="director" title="Edit Director" @add-item="handleEditDirector"></ActordirectorAdd>
  </div>
</template>
