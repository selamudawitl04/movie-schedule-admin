...
const handleAddActor = () => {
  ...
  onDone((result) => {
    ...
    const {mutate, onDone, onError, loading} = useMutation(addActor, () => ({
...
<template>
  <div>
    ...
    <div class=" w-4/6 mx-auto bg-white shadow-md rounded-sm py-10">
        <form @submit.prevent="handleAddActor" action=""> 
            <h1 class="text-center text-3xl font-bold text-primary9 py-10 uppercase">Add Actor</h1>
