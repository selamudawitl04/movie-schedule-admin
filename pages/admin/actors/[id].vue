...
// fetch actor
const { onResult, loading:actorLoading, onError:actorError, refetch } = authQuery(getActor, 'admin', {id})
onResult((result) => {
...
<template>
  <div>
    ...
    <AdminActorsAndDirectorAdd :item="actor"  title="Edit Actor" @add-item="handleEditActor"></AdminActorsAndDirectorAdd >
  </div>
</template>
