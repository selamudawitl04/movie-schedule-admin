...
<template>
    ...
    <div class=" w-full custom-shadow max-w-5xl flex justify-center px-6 mx-auto  shadow-md rounded-sm py-10">
      <Form @submit="handleAddMovie" class="w-3/4 relative"  :validation-schema="schema" v-slot="{ errors }">   
            ...
            <div class=" flex flex-col items-center  b w-full justify-start space-y-10">
                <div class=" grid grid-cols-2 gap-6 w-full">
                    ...
                    <div class="">
                        ...
                        <Field name="title"  v-model="title" type="text" class="border-2 p-2 border-gray rounded-md w-full focus:border-yellow-bright "  placeholder="title" :class="{ 'border-red': errors.title }" />
                    ...
                    <div class="">
                        ...
                        <Field name="duration"  v-model="duration" type="text" class="border-2 p-2 border-gray rounded-md w-full focus:border-yellow-bright "  placeholder="duration" :class="{ 'border-red': errors.duration }" />
                        <transition name="error">
                    ...
                    <div class="">
                        ...
                        <input required v-model="release_date" class="border-2 p-2 border-gray rounded-md w-full" type="datetime-local" name="" id="">
                    </div>
                    <DirectorsSet :selected-director="director.id" @set-director="setDirector"></DirectorsSet> 
                ...
                <div class=" flex flex-col space-y-6">
                  <ImagesMultiUpload />
                    ...
                    <div  class=" flex flex-col w-full ">
                        ...
                        <textarea required minlength="20" maxlength="1000" v-model="descrption"  class="border-2 p-2 border-gray rounded-md" name="" id="" cols="27" rows="3"></textarea>
                    </div> 
            </div>
            <button :disabled="isloading" class=" bg-opacity-60 hover:bg-opacity-100 font-bold text-white bg-yellow-bright  w-80 my-10 mx-auto block rounded-full p-2">Submit</button>
      </Form>
    </div>
</template>
