...
<template>
  <div>
    <div
      class="bg-white shadow-white shadow-md rounded-lg border border-gray-light mb-4 mx-4"
    >
      <!-- header -->
      <div
        class="p-2 flex justify-between text-primary-500 font-bold px-2 bg-movie-gray-900 bg-opacity-90 rounded-t-md"
      >
        <div>
          <BaseIcon
            color="green"
      ...
      <div class="text-white flex justify-between py-4 px-2 rounded-b-md">
        ...
        <div class="flex flex-col items-center">
          ...
          <button
            @click="deleteMessage"
            class="text-primary-500 font-bold bg-movie-gray-900 bg-opacity-80 rounded-md px-2 mb-2"
          >
            delete
          </button>
          ...
          <button
            @click="toggleReply"
            class="text-primary-500 font-bold bg-movie-gray-900 bg-opacity-80 rounded-md px-3"
          >
            reply
          </button>
        </div>
      ...
      >
        <div class="relative flex justify-between p-2">
          <span
            v-if="sending"
            class="absolute right-6 top-3 animate-spin text-9xl inline-block w-8 h-8 border-[3px] border-current border-t-transparent text-white rounded-full"
            role="status"
            aria-label="loading"
          ></span>
          <textarea
            ...
            id=""
            cols="75"
            class="p-1 rounded-md border border-gray-light"
            rows="2"
          ></textarea>
          ...
          <div class="ml-6 flex flex-col items-start">
            ...
            <button
              class="hover:bg-primary-500 hover:bg-opacity-70 w-full my-2 text-primary4 px-4 border-2 rounded-lg border-primary-500"
            >
              send
            </button>
          </div>
