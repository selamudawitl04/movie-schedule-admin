...
<template>
  <aside
    class="bg-gradient-to-br from-gray-dark to-gray-dark overflow-hidden fixed inset-0 z-50 my-4 ml-4 w-80 rounded-xl transition-transform duration-300 xl:translate-x-0"
  >
    <div class="relative border-b border-white/20">
      <NuxtLink class="flex justify-center items-center gap-4 py-6 px-8" to="/">
        <img
          src="@/assets/img/logo.png"
          class="inline-block relative object-cover object-center rounded-md"
        />
        <!-- <span class=" text-xl tracking-normal font-sans  font-semibold leading-relaxed text-white"> Admin Panel</span> -->
      </NuxtLink>
    </div>
    <div class="mx- h-[calc(100vh-32px)] overflow-y-scroll">
      <ul
        class="mb-24 mt-2 space-y-2 flex flex-col justify-center px-4 text-white font-bold"
      >
        <li class="  ">
          <NuxtLink
            class="px-2 block py-4 rounded-md w-full hover:bg-primary7"
            to="/"
          >
            <BaseIcon
        ...
        <li class=" ">
          <NuxtLink
            class="block px-2 bg-opacity-40 py-4 rounded-md w-full hover:bg-primary7"
        ...
        <li class=" ">
          <NuxtLink
            class="block px-2 bg-opacity-40 py-4 rounded-md w-full hover:bg-primary7"
            active-class="bg-primary-500 bg-opacity-40"
            to="/actors"
          >
            <BaseIcon
        ...
        <li class="">
          <NuxtLink
            active-class="bg-primary-500 bg-opacity-40"
            class="block px-1.5 bg-opacity-40 py-4 rounded-md w-full hover:bg-primary7"
            to="/notifications"
          >
            <BaseIcon
        ...
        <div class="">
          <button
            @click="logout"
            class="w-full items-center flex text-left bg-movie-gray-900 mb-2 text-white font-bold p-1.5 px-2 hover:bg-primary-500"
          >
            <BaseIcon
