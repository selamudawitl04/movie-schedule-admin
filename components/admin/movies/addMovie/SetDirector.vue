...
console.log(props.selectedDirector, 'props.selectedDirector')
...
const director_id = ref()
director_id.value = props.selectedDirector.id
const setDirector = ()=>{
    emit('set-director', director_id.value)
}
</script>
<template>
    <div class="flex flex-col ">
        <label class=" text-primary9 font-bold" for="director"> Director</label>
        <select @change="setDirector" v-model="director_id"  name="director" id="director" class="border-2 p-2 border-gray rounded-md">
