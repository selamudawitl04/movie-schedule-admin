...
<template>
    <div class="flex flex-col ">
        ...
        <select @change="setDirector" v-model="dir_id"  name="director" id="director" class="border-2 p-2 border-gray rounded-md">
            ...
            <option  name="director" class=" hover:bg-yellow-bright" 
