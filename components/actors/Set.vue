<script setup>
// this component is used to set actors to movie and it is used in add and edit movie page
// first it fetch all actors from the database
// then it display the actors according to the search value
// then it display the selected actors
...
// this function is called when an actor is selected  from displayed actors
// the actor is added to the selected actors array and in each selection the actors list in
// the add movie or edit movie page is updated
